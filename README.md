# Espees Max Pro - Next.js (v2.2)

[Espees Max](https://espeesmax.com) is a modern, responsive, and customizable admin dashboard template built using
Tailwind CSS and Next.js. It is designed to help developers build beautiful and functional dashboards quickly and
easily.

## Quick Links

- [✨ Visit Website](https://espeesmax.com)
- [📄 Documentation](https://espeesmax.com/docs)
- [⬇️ Download](https://espeesmax.com/download)
- [🌐 Live Site](https://nextjs-demo.espeesmax.com)

## Installation

### Prerequisites

To get started with Espees Max, ensure you have the following prerequisites installed and set up:
...
[Read more](https://espeesmax.com/docs/update-logs/nextjs) on this release.
...
Refer to our [LICENSE](https://espeesmax.com/license) page for more information.
# espees-payment-forms
