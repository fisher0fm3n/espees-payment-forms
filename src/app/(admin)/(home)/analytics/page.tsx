...
export const metadata: Metadata = {
  title: "Next.js Analytics Dashboard | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Analytics Dashboard page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
