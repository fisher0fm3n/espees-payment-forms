...
export const metadata: Metadata = {
  title: "Next.js CRM Dashboard | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js CRM Dashboard page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
