...
export const metadata: Metadata = {
  title: "Next.js Logistics Dashboard | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js  Logistics Dashboard for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
