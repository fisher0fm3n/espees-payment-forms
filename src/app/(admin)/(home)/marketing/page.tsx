...
export const metadata: Metadata = {
  title:
    "Next.js Marketing Dashboard | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Marketing Dashboard page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
