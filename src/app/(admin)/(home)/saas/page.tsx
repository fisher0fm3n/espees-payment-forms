...
export const metadata: Metadata = {
  title:
    "Next.js SaaS Dashboard | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js SaaS Dashboard page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
