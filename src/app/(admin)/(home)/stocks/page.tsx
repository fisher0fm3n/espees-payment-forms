...
export const metadata: Metadata = {
  title: "Next.js Stocks Dashboard | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Stocks Dashboard page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
