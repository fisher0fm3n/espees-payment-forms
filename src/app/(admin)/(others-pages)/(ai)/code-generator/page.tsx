...
export const metadata: Metadata = {
  title:
    "Next.js AI Code Generator | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js AI Code Generator page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
