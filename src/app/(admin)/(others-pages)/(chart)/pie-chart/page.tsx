...
export const metadata: Metadata = {
  title: "Next.js Pie Chart | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Pie Chart page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
