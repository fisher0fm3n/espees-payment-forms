...
export const metadata: Metadata = {
  title:
    "Next.js E-commerce  Create Invoice Page | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js E-commerce  Create Invoice Page Espees Max Dashboard Template",
};
