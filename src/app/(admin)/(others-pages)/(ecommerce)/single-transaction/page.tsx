...
export const metadata: Metadata = {
  title:
    "Next.js E-commerce Single Transaction | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js E-commerce Single Transaction Espees Max Dashboard Template",
};
