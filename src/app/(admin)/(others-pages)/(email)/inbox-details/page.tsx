...
export const metadata: Metadata = {
  title: "Next.js Inbox Details | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Inbox Details page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
