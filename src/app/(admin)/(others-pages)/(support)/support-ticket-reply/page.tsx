...
export const metadata: Metadata = {
  title: "Next.js Support Reply | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Support Reply for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
