...
export const metadata: Metadata = {
  title: "Next.js Basic Data Table | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Basic Data Table page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
