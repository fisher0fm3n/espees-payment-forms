...
export const metadata: Metadata = {
  title: "Next.js Messages | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Messages page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
