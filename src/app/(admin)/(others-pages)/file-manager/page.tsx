...
export const metadata: Metadata = {
  title: "Next.js FileManager Page | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js FileManager page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
