...
export const metadata: Metadata = {
  title:
    "Next.js Integrations Page | Espees Max - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Integrations page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
