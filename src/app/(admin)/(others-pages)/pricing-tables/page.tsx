...
export const metadata: Metadata = {
  title: "Next.js Pricing Table | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Pricing Table page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
