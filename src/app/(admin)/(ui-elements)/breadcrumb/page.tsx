...
export const metadata: Metadata = {
  title: "Next.js Breadcrumbs | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Breadcrumbs page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
