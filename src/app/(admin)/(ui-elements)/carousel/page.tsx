...
export const metadata: Metadata = {
  title: "Next.js Carousel | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Carousel page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
