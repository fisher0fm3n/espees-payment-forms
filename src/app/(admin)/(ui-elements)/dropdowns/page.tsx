...
export const metadata: Metadata = {
  title: "Next.js Dropdowns | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Dropdowns page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
