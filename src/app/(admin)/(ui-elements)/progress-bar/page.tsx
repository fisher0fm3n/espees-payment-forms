...
export const metadata: Metadata = {
  title: "Next.js Progress | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Progress page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
