...
export const metadata: Metadata = {
  title: "Next.js Spinners | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Spinners page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
