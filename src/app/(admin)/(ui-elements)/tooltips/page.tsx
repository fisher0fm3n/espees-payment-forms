...
export const metadata: Metadata = {
  title: "Next.js Tooltips | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Tooltips page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
