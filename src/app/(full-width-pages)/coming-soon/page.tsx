...
export const metadata: Metadata = {
  title: "Next.js Coming Soon Page | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Coming Soon page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
