...
export const metadata: Metadata = {
  title: "Next.js Success Page | Espees Max - Next.js Dashboard Template",
  description:
    "This is Next.js Success page for Espees Max - Next.js Tailwind CSS Admin Dashboard Template",
};
