        ...
        <div className="custom-scrollbar h-[calc(58vh-162px)] space-y-7 divide-y divide-gray-200 overflow-y-auto pr-2 dark:divide-gray-800">
          <article>
            ...
            <div className="pb-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                I’m currently working on customizing the Espees Max dashboard and
          ...
          <article>
            ...
            <div className="pb-6">
              ...
              <p className="mb-5 text-sm text-gray-500 dark:text-gray-400">
                ...
                customizing Espees Max to fit your needs! Yes, you can definitely
